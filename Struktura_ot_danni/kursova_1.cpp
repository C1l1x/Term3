/*
    Даден е списък от символни низове. Да се напише програма, която намира броя на низовете със зададена дължина и създава нов списък, съдържащ само низовете с дължина, по-малка от зададената.
*/
