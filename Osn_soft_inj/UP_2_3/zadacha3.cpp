/*
В магазин за хранителни продукти, за всеки продукт се въвеждат:
    - код
    - име 
    - мярка
    - единична цена
    - количество
Да се състави алгоритъм и напише програма, която въвежда в маисв данни за определен брой
продукти и изчислява наличната стока в парично изражение.
*/
